...
$opt_name = 'simple_event_data';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__('Simple Options', 'simpleeventtemplate'),

	// The text to appear on the page title.
	'page_title'                => esc_html__('Simple Options', 'simpleeventtemplate'),
...
Redux::set_section($opt_name, array(
	'title' => __('Header', 'simpleeventtemplate'),
	'id' => 'simpleevent-header-section',
	'icon' => "fa-solid fa-screwdriver-wrench",
	'fields' => array(
		array(
			'title' => __('Facebook Icon', 'simpleeventtemplate'),
			'id' => 'simpleevent-facebook-icon',
			'type' => 'text',
			'description' => __('please inter your icon class name and url', 'simpleeventtemplate')
		),
		array(
			'title' => __('Facebook URL', 'simpleeventtemplate'),
			'id' => 'simpleevent-fb-url',
			'type' => 'text',
			'validate' => 'url',
			'description' => __('please inter your icon class name and url', 'simpleeventtemplate')
		),
		array(
			'title' => __('Twitter Icon', 'simpleeventtemplate'),
			'id' => 'simpleevent-twitter-icon',
			'type' => 'text',
			'description' => __('please inter your icon class name and url', 'simpleeventtemplate')
		),
		array(
			'title' => __('Twitter URL', 'simpleeventtemplate'),
			'id' => 'simpleevent-tt-url',
			'type' => 'text',
			'validate' => 'url',
			'description' => __('please inter your icon class name and url', 'simpleeventtemplate')
		),
		array(
			'title' => __('Skype Icon', 'simpleeventtemplate'),
			'id' => 'simpleevent-skype-icon',
			'type' => 'text',
			'description' => __('please inter your icon class name and url', 'simpleeventtemplate')
		),
		array(
			'title' => __('Skype URL', 'simpleeventtemplate'),
			'id' => 'simpleevent-sy-url',
			'type' => 'text',
			'validate' => 'url',
			'description' => __('please inter your icon class name and url', 'simpleeventtemplate')
		),
		array(
			'title' => __('Media', 'simpleeventtemplate'),
			'id' => 'simpleevent-img',
			'type' => 'media',
			'description' => __('please upload image', 'simpleeventtemplate')
		),
...
Redux::set_section($opt_name, array(
	'title'		 => __('logo', 'simpleeventtemplate'),
	'id' 		 => 'simpleevent-logo-section',
	'subsection' => true,
	'icon'		 => "fa-solid fa-screwdriver-wrench",
	'fields' 	 => array(
		array(
...
Redux::set_section($opt_name, array(
	'title'		 => __('Gellary', 'simpleeventtemplate'),
	'id' 		 => 'simpleevent-gellary-section',
	'icon'		 => "fa-solid fa-screwdriver-wrench",
	'fields' 	 => array(
		// 1
		array(
			...
			'id'   	  => 'simple-gellary',
			'type'    => 'media',
			'desc' => esc_html(__('this is description', 'simpleeventtemplate'))
		),
		// 2
		array(
			"title"   => __('Textarea', 'simpleeventtemplate'),
			'id'   	  => 'simple-textarea',
			'type'    => 'textarea',
			'desc' => esc_html(__('this is description', 'simpleeventtemplate'))
		),
		// 3
		array(
			"title"   => __('Switch', 'simpleeventtemplate'),
			'id'   	  => 'simple-switch',
			'type'    => 'switch',
			'desc' => esc_html(__('this is description', 'simpleeventtemplate'))
		),
		// 4
		array(
			"title"   => __('Checkbox', 'simpleeventtemplate'),
			'id'   	  => 'simple-checkbox',
			'type'    => 'checkbox',
			'desc' => esc_html(__('this is discription', 'simpleeventtemplate')),
			'options'  => array(
				'1' => 'Opt 1',
				'2' => 'Opt 2',
				'3' => 'Opt 3'
		...
		// 5
		array(
			"title"   => __('Date', 'simpleeventtemplate'),
			'id'   	  => 'simple-date',
			'type'    => 'date',
		...
		array(
			...
			'id'       => 'simple-layout',
			'type'     => 'image_select',
			'title'    => esc_html__('Main Layout', 'simpleeventtemplate'),
			'subtitle' => esc_html__('Select main content and sidebar alignment. Choose between 1, 2 or 3 column layout.', 'simpleeventtemplate'),
			'desc' => esc_html(__('this is discription', 'simpleeventtemplate')),
			'options'  => array(
				'1'      => array(
					'alt'   => '1 Column',
					'img'   => get_theme_file_uri('layout/about-me.gif')
				),
				'2'      => array(
					'alt'   => '2 Column Left',
					'img'   => get_theme_file_uri('layout/art-img.gif')
				),
				'3'      => array(
					'alt'   => '2 Column Right',
					'img'  => get_theme_file_uri('layout/header.jpg')
				),
				'4'      => array(
					'alt'   => '3 Column Middle',
					'img'   => get_theme_file_uri('layout/more.jpg')
				),
				'5'      => array(
					'alt'   => '3 Column Left',
					'img'   => get_theme_file_uri('layout/new-img.gif')
				),
				'6'      => array(
					'alt'  => '3 Column Right',
					'img'  => get_theme_file_uri('layout/new-img.gif')
		...
		// 7
		array(
			"title"   => __('Multi-Text', 'simpleeventtemplate'),
			'id'   	  => 'simple-multi-text',
			'type'    => 'multi_text',
			'desc' => esc_html(__('this is discription', 'simpleeventtemplate'))
		),
		// 8
		array(
			"title"   => __('Slider', 'simpleeventtemplate'),
			'id'   	  => 'simple-slider',
			'type'    => 'slider',
			'full_width'  => false,
			'markdown' => true,
		...
		// 9
		array(
			"title"   => __('spacing', 'simpleeventtemplate'),
			'id'   	  => 'simple-spacing',
			'type'           => 'spacing',
		...
		// 10
		array(
			"title"   => __('Radio', 'simpleeventtemplate'),
			'id'   	  => 'simple-radio',
			'type'    => 'radio',
			'data'  => array(
				'1' => 'Opt 1',
